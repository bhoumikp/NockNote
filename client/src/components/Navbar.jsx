...
const Navbar = () => {
    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-light px-5" id="navbar" style={{ backgroundColor: "#b3ffb3" }}>
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    {!localStorage.getItem('token') ?
                        ...
                        :
                        <div>
                            <span  style={{fontSize: "1rem" , borderRight:"3px solid black" , paddingRight:"10px"}}>
                                {username}
                            </span>
